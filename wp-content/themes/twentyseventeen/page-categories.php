...
<div class="col-9 col-m-12">
	<div id = "leftcolumn">
		<div class="titlehead">
			<h6 style="text-transform: capitalize;">Category: <?php echo $cat;?></h6>
		</div>
		<div id="ta" class="tacontent">
			<?php
			$catresult = mysqli_query($conn, "SELECT * FROM kbs_posts WHERE post_category='$cat' ORDER BY post_id DESC");
