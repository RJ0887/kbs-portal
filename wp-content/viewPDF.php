...
if ($login == 1) {  
	...
	if ($pdfResult->num_rows > 0) {
		...
		echo '<iframe style="position:fixed; top:0px; left:0px; bottom:0px; right:0px; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;" src="data:'.$uploadType.';base64,' .$uploadData. '"/>';
	} else {
		echo "<script>
